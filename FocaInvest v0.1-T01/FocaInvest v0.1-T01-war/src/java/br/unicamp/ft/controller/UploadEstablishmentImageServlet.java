 ...
 * @author Matheus
 */
@WebServlet(name = "UploadEstablishmentImageServlet", urlPatterns = {"/UploadEstablishmentImageServlet"})
public class UploadEstablishmentImageServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UploadEstablishmentImageServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
