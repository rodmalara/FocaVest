 ...
 * @author Matheus
 */
@WebServlet(name = "SelectEstablishmentIdServlet", urlPatterns = {"/Customer/SelectEstablishmentIdServlet"})
public class SelectEstablishmentIdServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        EstabelecimentoTO estabelecimentoTO = new
         EstabelecimentoDAO().selectByID(Integer.parseInt(request.getParameter("barId")));
        
        List<EventoTO> listEvento = new EventoDAO().
                selectListEventoByEstabelecimentoID(estabelecimentoTO.getEstabelecimentoID());
